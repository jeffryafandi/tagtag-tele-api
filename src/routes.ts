...
const publicRoutes: any = {
    ...
    "PUT /auths/change-password/request": "controllers/auth.changePasswordRequest",
    "GET /auths/forgot-password": "controllers/auth.forgotPasswordPage",
    "POST /auths/forgot-password/request": "controllers/auth.forgotPasswordRequest",
    "POST /auths/forgotPassword/check": "controllers/auth.checkChangePasswordToken",
    ...
    "POST /auths/affiliate/upgrade": "controllers/affiliate.affiliateUpgradeRequest",
    "GET /affiliates/upgrade/approved": "controllers/affiliate.upgradeRequestApproved",
    "POST /revenue-baselines": "controllers/revenue.addRevenueBaseline",
    "POST /revenue-baselines/publish": "controllers/revenue.publishRevenueBaseline",
    "POST /schedular/mark-daily-logins": "controllers/scheduler.markDailyLogin",
    "POST /schedular/refresh-lucky-wheel-entries": "controllers/scheduler.resetLuckyWheel",
    "POST /schedular/refresh-quest-assignments": "controllers/scheduler.reassignQuest",
    "POST /schedular/refresh-mission-assignments": "controllers/scheduler.refreshMission",
    "POST /schedular/calculate-prizepools": "controllers/scheduler.calculatePrizepool",
    "POST /schedular/send-notification": "controllers/scheduler.sendingNotification",
    "POST /schedular/check-user-activities": "controllers/scheduler.checkUserActivity",
    "POST /schedular/check-raffle-status": "controllers/scheduler.checkRaffleStatus",
    "POST /schedular/expiring-user-ban": "controllers/scheduler.expireUserBan",
    "POST /schedular/generate-mystery-boxes": "controllers/scheduler.generateMysteryBoxPrizes",
    "POST /schedular/validateStoreUserPurchase": "controllers/scheduler.validateStoreUserPurchase",
    "POST /schedular/reset-mission-assignments": "controllers/scheduler.resetMission",
    "POST /schedular/test-midtrans-disbursement": "controllers/scheduler.testMidtransDisbursement",
    "POST /schedular/redis-set-winners-data": "controllers/scheduler.redisSetWinnersData",
    "POST /schedular/reassign-quest-preset": "controllers/scheduler.reassignQuestPreset",
    "POST /prizepools": "controllers/prizepool.prizepoolInit",
    "GET /prizepools/leaderboard/{type}": "controllers/prizepool.getLeaderBoardPrizepool",
    ...
    "GET /test/midtrans/accountvalidation": "controllers/test.midtransAccountValidation",
    ...
    "PUT /user-verifications/{verificationId}/status": "controllers/user.updateVerificationStatus",
...
const privateAdminRoutes: any = {
    ...
    "GET /admin/lucky-wheels/{luckyWheelId}": "controllers/admin/lucky-wheels.luckyWheelDetail",
    "POST /admin/lucky-wheels": "controllers/admin/lucky-wheels.createLuckyWheel",
    "PUT /admin/lucky-wheels/{luckyWheelId}": "controllers/admin/lucky-wheels.updateLuckyWheel",
    "DELETE /admin/lucky-wheels/{luckyWheelId}": "controllers/admin/lucky-wheels.deleteLuckyWheel",
    "POST /admin/lucky-wheels/{luckyWheelId}/add-prize": "controllers/admin/lucky-wheels.createLuckyWheelPrizes",
    "PUT /admin/lucky-wheel-prizes/{luckyWheelPrizeId}": "controllers/admin/lucky-wheels.updateLuckyWheelPrizes",
    "DELETE /admin/lucky-wheel-prizes/{luckyWheelPrizeId}": "controllers/admin/lucky-wheels.deleteLuckyWheelPrizes",
    ...
    "GET /admin/transaction-log/user": "controllers/admin/transaction.userHistoryLogTransaction",
    "POST /admin/partner/ads": "controllers/admin/partner.addNewAdForPartner",
    "GET /admin/raffle-log-winners/user": "controllers/admin/raffle.userHistoryLogRaffleWinners",
    "GET /admin/users-revenue-detail": "controllers/admin/revenue.usersRevenueDetail",
    "GET /admin/users-withdraw-detail": "controllers/admin/user.userWithdrawDetail",
    "GET /admin/lucky-wheels-analytic": "controllers/admin/lucky-wheels.getLuckyWheelAnalytic",
    "GET /admin/lucky-wheels-log": "controllers/admin/lucky-wheels.getLuckyWheelLog",
}
...
const privateRoutes: any = {
    ...
    "POST /auths/account-validation/gopay": "controllers/auth.userAccountValidationGopay",
    ...
    "POST /lucky-wheels/reset-entries": "controllers/lucky-wheels.resetSpinEntries",
    "PUT /daily-logins/claim": "controllers/daily-login.claim",
    "PUT /referrals/claim": "controllers/referrals.userClaim",
    "PUT /affiliates/upgrade/{affiliateUpgradeId}/status": "controllers/affiliate.updateAffiliateUpgradeStatus",
    "GET /missions/{missionId}/status": "controllers/mission.getMissionStatus",
    "PUT /missions/{missionId}/{action}": "controllers/mission.userMissionHandler",
    "POST /missions/{missionId}/start": "controllers/mission.startingMission",
    "POST /missions/{missionId}/ad-mission-view-confirmation": "controllers/mission.adMissionViewConfirmation",
    ...
    "POST /quests/{questId}/ad-quest-view-confirmation": "controllers/quest.adQuestViewConfirmation",
    "PUT /freeplay/{gameId}/finish": "controllers/freeplay.finishingFreeplay",
    "POST /ads/log": "controllers/ads-log.logging",
    "GET /in-app-purchases/products": "controllers/in-app-purchase.getInAppProducts",
    "POST /in-app-purchases": "controllers/in-app-purchase.storeInAppPurchase",
    "PUT /in-app-purchases/{token}/status": "controllers/in-app-purchase.updateInAppPurchase",
    ...
    "GET /prizepools/histories": "controllers/prizepool.getPrizepoolParticipations",
    "GET /prizepools": "controllers/prizepool.homePrizepools",
    "GET /prizepools/{prizepoolId}/winners": "controllers/prizepool.getPrizepoolWinners",
    ...
    "POST /in-app-purchases/create-payment": "controllers/in-app-purchase.createPayment",
    "GET /rewarded-ads": "controllers/rewarded-ads.getRewardedAds",
    "PUT /rewarded-ads/{rewardedAdsId}/finish": "controllers/rewarded-ads.finishingRewardedAds",
...
const privateHandler = async (event: lambda.APIGatewayProxyEvent, context: lambda.Context, callback: lambda.Callback): Promise<lambda.APIGatewayProxyResult> => {
    ...
    if (!handlerPath) {
        return {
            statusCode: 404,
            body: JSON.stringify({ message: `No handler found for route ${routeKey}` }),
        };
    }

    const [modulePath, functionName] = handlerPath.split('.');
    console.log(`Module path: ${modulePath}, Function name: ${functionName}, Handler path: ${handlerPath}`);
    // const params = {
...
const publicHandler = async (event: lambda.APIGatewayProxyEvent, context: lambda.Context, callback: lambda.Callback): Promise<lambda.APIGatewayProxyResult> => {
    const httpMethod = event.httpMethod;
    let path = event.path;
    const basePath = '/production';
    if (path.startsWith(basePath)) {
    ...
    if (!handlerPath) {
        return {
            statusCode: 404,
            body: JSON.stringify({ message: `No handler found for public route ${routeKey}` }),
        };
    }
...
const privateAdminHandler = async (event: lambda.APIGatewayProxyEvent, context: lambda.Context, callback: lambda.Callback): Promise<lambda.APIGatewayProxyResult> => {
    const httpMethod = event.httpMethod;
    let path = event.path;
    const routeKey = `${httpMethod} ${path}`;
    const basePath = '/production';
    ...
    console.log(`Accessing ${routeKey}`);
    const handlerPath = matchRoute(privateAdminRoutes, routeKey, httpMethod, path);
    if (!handlerPath) {
        return {
            statusCode: 404,
            body: JSON.stringify({ message: `No handler found for route ${routeKey}` }),
...
const matchRoute = (routes: any, routeKey: string, method: string, path: string) => {
    ...
    for (const [route, handler] of Object.entries(routes)) {
        ...
        if (routeMethod === method) {
            ...
            const routeRegex = new RegExp(
                '^' +
                routePath
                    .replace(/{([^}]+)}/g, '([^/]+)') + // Replace {param} with regex to capture multiple parameters
                '$'
            );
...
exports.privateHandler = new MiddlewareWrapper().init(privateHandler, [unfiedHandlerMiddleware()])
exports.publicHandler = new MiddlewareWrapper().init(publicHandler, [unfiedHandlerMiddleware()])
exports.privateAdminHandler = new MiddlewareWrapper().init(privateAdminHandler, [unfiedHandlerMiddleware()])