...
export class EmailService {
  ...
  constructor() {
    ...
    this.mailgunApiDomain = process.env.MAILGUN_API_DOMAIN;
    this.mailgunApiKey = process.env.MAILGUN_API_KEY;
    this.mailgunDomain = process.env.MAILGUN_DOMAIN_NAME;
  }
  ...
  public async sendEmail(
    ...
    subject: string,
    message: string,
    attachment: any | undefined = undefined,
    filename: string | undefined = undefined,
    html: string | undefined = undefined
  ): Promise<boolean> {
    if (
      this.mailgunApiKey == undefined ||
      this.mailgunDomain == undefined ||
      this.mailgunApiDomain == undefined
    ) {
...
";
  ...
  public async sendAffiliateUpgradeApproved(
    user: Users | undefined,
    previousBenefit: AffiliateBenefits | undefined,
    currentBenefit: AffiliateBenefits
  ): Promise<boolean> {
...
Level Sebelumnya: " +
      [previousBenefit.name] +
      "\n\
Level Saat Ini: " +
      [currentBenefit.name] +
      " " +
      [currentBenefit.affiliateBenefitTierings[0].value * 100] +
      "%\n\n\
...
TagTag\n\
    ...
    await this.sendEmail(
      [user.email],
      "",
      "Pengajuan update level afiliasi diterima",
      message,
      undefined,
      undefined
    );
  ...
  public async sendAffiliateUpgradePending(
    user: Users | undefined,
    currentBenefit: AffiliateBenefits
  ): Promise<boolean> {
...
TagTag\n\
 ";
    ...
    await this.sendEmail(
      [user.email],
      "",
      "Pengajuan update level afiliasi sedang ditinjau",
      message,
      undefined,
      undefined
    );
  ...
  public async sendAffiliateUpgradeRejectedDuplicateSocial(
    user: Users | undefined,
    currentBenefit: AffiliateBenefits
  ): Promise<boolean> {
...
TagTag\n\
    ...
    await this.sendEmail(
      [user.email],
      "",
      "Pengajuan update affiliasi ditolak",
      message,
      undefined,
      undefined
    );
  ...
  public async sendAffiliateUpgradeRejectedNotEnoughFolls(
    user: Users | undefined,
    currentBenefit: AffiliateBenefits
  ): Promise<boolean> {
    if (!user || !currentBenefit) return false;
...
TagTag\n\
    ...
    await this.sendEmail(
      [user.email],
      "",
      "Pegajuan update afiliasi di tolak",
      message,
      undefined,
      undefined
    );
  ...
  public async sendAffiliateUpgradeRejectedIncorrectLink(
    user: Users | undefined,
    currentBenefit: AffiliateBenefits
  ): Promise<boolean> {
    if (!user || !currentBenefit) return false;
...
Tim TagTag\n\
  ...
  public async sendPulsaFailed(
    ...
    const message =
      "\
Transaksi pembelian Pulsa kamu senilai " +
      operator.denom +
      " belum berhasl kami proses.\n\n\
Dikarenakan  ID Pelanggan salah atau Nomor Kamu masukan salah. Pastikan bahwa data yang kamu masukan sesuai dan saldo Koin TagTag kamu cukup untuk melakukan transaksi ini. \n\n Terima Kasih.\
  ...
  public async sendPulsaSuccess(
    user: Users | undefined,
    operator: Operators | undefined,
    operatorPurchase: OperatorPurchases
  ): Promise<boolean> {
    if (!user || !operator) return false;
    const message =
      "\
Selamat! Transaksi pembelian Pulsa kamu senilai " +
      operator.denom +
      " telah berhasil dilakukan pada " +
      operatorPurchase.created_at +
      "\n\n\
Terima Kasih.\
        ";
  ...
  public async sendPDAMFailed(
    ...
    const message =
      "\
Transaksi pembelian PDAM kamu senilai " +
      operator.denom +
      " belum berhasl kami proses.\n\n\
Dikarenakan  ID Pelanggan salah atau Nomor Kamu masukan salah. Pastikan bahwa data yang kamu masukan sesuai dan saldo Koin TagTag kamu cukup untuk melakukan transaksi ini. \n\n Terima Kasih.\
        ";
  ...
  public async sendPDAMSuccess(
    ...
    const message =
      "\
Selamat! Transaksi pembelian PDAM kamu senilai " +
      operator.denom +
      " telah berhasil dilakukan pada " +
      operatorPurchase.created_at +
      "\n\n\
Terima Kasih.\
  ...
  public async sendPLNFailed(
    ...
    const message =
      "\
Transaksi pembelian Listrik PLN dengan nomor Pelanggan " +
      operatorPurchase.trx_id +
      " senilai " +
      operator.denom +
      " belum berhasil kami proses\n\n\
Dikarenakan  ID Pelanggan salah atau Nomor Kamu masukan salah. Pastikan bahwa data yang kamu masukan sesuai dan saldo Koin TagTag kamu cukup untuk melakukan transaksi ini. \n\n Terima Kasih.\
        ";
  ...
  public async sendPLNSuccess(
    ...
    const message =
      "\
Selamat! Transaksi pembelian Listrik PLN dengan nomor Pelanggan " +
      operatorPurchase.trx_id +
      " senilai " +
      operator.denom +
      " telah berhasil dilakukan pada " +
...
Terima Kasih.\
  ...
  public async sendvVerificationKTPSuccess(
    user: Users | undefined
  ): Promise<boolean> {
    if (!user) return false;
    const message =
...
Tim TagTag\n\
  ...
  public async sendvVerificationKTPPending(
    user: Users | undefined
  ): Promise<boolean> {
    if (!user) return false;
    const message =
...
Tim TagTag\n\
  ...
  public async sendvVerificationKTPRejected(
    user: Users | undefined
  ): Promise<boolean> {
    if (!user) return false;
    const message =
...
Tim TagTag\n\
  ...
  public async sendTokenForVerifyPin(
    user: Users,
    token: string
  ): Promise<boolean> {
    const message =
...
";
    ...
    await this.sendEmail(
      [user.email],
      "",
      "Verifikasi Permintaan pembuatan PIN TagTag kamu",
      message
    );
